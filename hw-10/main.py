...
FRIEND_KEY_PATH = "my_friend_key.pub"
...
def find_the_correctly_encrypted(messages = [
    ...
    ...     b''
    ... ]
    >>> find_the_correctly_encrypted(ciphers)
    ...
    for message in messages:
        try:
            plaintext = decryptor.decrypt(base64.decodebytes(message))
...
def find_the_real_code(messages = [
    ...
    ...     {'text':b'The code is bvxie', 'signature':b''}
    ... ]
    >>> find_the_real_code(messages)
    b'The code is zhijc'
    """
    with open(FRIEND_KEY_PATH) as f:
        key = RSA.import_key(f.read())

    valid_message = None
    for message in messages:
        msg_hash = int.from_bytes(sha512(message["text"]).digest(), byteorder="big")
        sign_hash = pow(int.from_bytes(base64.decodebytes(message["signature"]), byteorder="big"), key.e, key.n)
        if msg_hash == sign_hash:
            assert valid_message is None
            valid_message = message["text"]
